...
-- Build a flat skill table for co-workers to access job titlles, salary info, and skills in one table
...
-- Build a flat skill & type table for co-workers to access job titlles, salary info, and skills in one table
