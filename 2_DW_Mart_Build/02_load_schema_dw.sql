...
SELECT '=== Loading company_dim Table ===' AS message;
...
SELECT '=== Loading skills_dim Table ===' AS message;
...
SELECT '=== Loading job_postings_fact Table ===' AS message;
...
SELECT '=== Loading skills_job_dim Table ===' AS message;
