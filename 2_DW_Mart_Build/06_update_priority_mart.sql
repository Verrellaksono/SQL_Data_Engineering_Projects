-- Step 6: Mart - Updte priority roles mart

-- Update Data Engineer to Priority 1
SELECT '=== Updating Roles for Priority Mart ===' AS message;
UPDATE priority_mart.priority_roles
SET priority_lvl = 1
WHERE role_name = 'Data Engineer';

-- Add Data Scientist as Level 3
SELECT '=== Adding Roles for Priority Mart ===' AS message;
...
-- Create Temp Table
SELECT '=== Creating Temp Source Table for Priority Mart ===' AS message;
...
-- Merge Into
SELECT '=== Batch Updating priority_jobs_snapshot for Priority Mart = ==' AS message;
