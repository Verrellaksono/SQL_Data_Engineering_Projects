...
SELECT '=== Loading Skill Fact for Skills Mart ===' AS message;
...
SELECT '===  Loading Date Dimension for Skills Mart ===' AS message;
...
SELECT '=== Loading Skill Demand Fact for Skills Mart ===' AS message;
...
UNION ALL
SELECT 'Date Dimension', COUNT(*) FROM skills_mart.dim_date_month
UNION ALL
SELECT 'Fact Table', COUNT(*) FROM skills_mart.fact_skill_demand_monthly;


SELECT '=== Skill Dimension Sample ===' AS message;
SELECT * FROM skills_mart.dim_skills LIMIT 5;

SELECT '=== Date Dimension Sample ===' AS message;
SELECT * FROM skills_mart.dim_date_month LIMIT 5;

SELECT '=== Fact Table Sample ' AS message;
